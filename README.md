...
```bash
git clone https://github.com/<your_github_username>/JGEC_GYM_BROS.git
```
...
Go to the original [soumik7063/JGEC_GYM_BROS](https://github.com/soumik7063/JGEC_GYM_BROS) repository on GitHub. You will see a green "Compare & pull request" button. Click it and describe your work!
